...
/* MALHA VIÁRIA RECALIBRADA SOBRE A ARTE OFICIAL. Cada coordenada abaixo fica no eixo central do asfalto; o táxi só interpola entre dois eixos de rua conectados. */
const P={
A0:[28.2,20.7],A1:[44.3,20.7],A2:[60.1,20.7],A3:[76.8,20.7],A4:[88.3,20.7],
B0:[28.2,43.0],B1:[44.3,43.0],B2:[60.1,43.0],B3:[76.8,43.0],B4:[88.3,43.0],
C0:[28.2,62.1],C1:[44.3,62.1],C2:[60.1,62.1],C3:[76.8,62.1],C4:[88.3,62.1],
D0:[28.2,84.1],D1:[44.3,84.1],D2:[60.1,84.1],D3:[76.8,84.1],D4:[88.3,84.1]
};
...
function aplicarModelo(perfil={}){modeloAtual=escolherModelo(perfil);taxiImg.src=modeloAtual.arquivo+'?v=20260925-1';taxiImg.alt='Táxi '+modeloAtual.nome;taxi.dataset.modelo=String(modeloAtual.nivel);taxi.title='Táxi '+modeloAtual.nome;return modeloAtual}
