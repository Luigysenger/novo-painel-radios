...
/* MALHA VIÁRIA DA ARTE 1536x1024. Pontos ficam no CENTRO do asfalto, nunca nos lotes/calçadas. */
const P={
A0:[30.2,21.2],A1:[46.0,21.2],A2:[61.8,21.2],A3:[77.4,21.2],A4:[91.0,21.2],
B0:[30.2,44.2],B1:[46.0,44.2],B2:[61.8,44.2],B3:[77.4,44.2],B4:[91.0,44.2],
C0:[30.2,64.4],C1:[46.0,64.4],C2:[61.8,64.4],C3:[77.4,64.4],C4:[91.0,64.4],
D0:[30.2,84.9],D1:[46.0,84.9],D2:[61.8,84.9],D3:[77.4,84.9],D4:[91.0,84.9]
};
...
function aplicarModelo(perfil={}){modeloAtual=escolherModelo(perfil);taxiImg.src=modeloAtual.arquivo+'?v=20260925-2';taxiImg.alt='Táxi '+modeloAtual.nome;taxi.dataset.modelo=String(modeloAtual.nivel);taxi.title='Táxi '+modeloAtual.nome;return modeloAtual}
...
function animarTrecho(de,para,cb){orientar(de,para);const dist=Math.hypot(para[0]-de[0],para[1]-de[1]);const dur=Math.max(4000,dist*270);taxi.style.transition=`left ${dur}ms linear,top ${dur}ms linear,transform 260ms ease`;requestAnimationFrame(()=>{posXY(para[0],para[1]);setTimeout(cb,dur+60)})}
